package com.example.springbootmb.util.mbg;

import com.example.springbootmb.util.mbg.entity.MBG;
import com.example.springbootmb.util.mbg.entity.TableConfig;
...
//            context.addProperty("endingDelimiter", "`");
        ...
        List<TableConfig> tableNames = mbg.getTableConfigs();
        for (TableConfig tableConfig : tableNames) {
